...
| FR-016 / US-12 (діалоговий оркестратор, no API key) | ADR-0006 | T-022 | test_wrapper_has_orchestrator_markers | ✅ |
| FR-017 (install/remove субагентів + self-upgrade) | ADR-0006 | T-023 | test_install_writes_command_and_agents, test_command_self_upgrades_on_old_version | ✅ |
